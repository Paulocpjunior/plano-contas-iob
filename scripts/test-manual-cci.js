...
assert.strictEqual(manual.conteudo.manual_version, '2.0', 'A versão atual do manual deve estar explícita.');
...
console.log('OK: Manual CCI v2.0 usa fonte única no app, na Ajuda e nos downloads versionados.');
