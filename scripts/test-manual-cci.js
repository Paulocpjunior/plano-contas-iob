...
assert.strictEqual(manual.conteudo.manual_version, '2.5', 'A versão atual do manual deve estar explícita.');
...
console.log('OK: Manual CCI v2.5 usa fonte única no app, na Ajuda e nos downloads versionados.');
