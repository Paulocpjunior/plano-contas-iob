...
assertContains('server.js', "express.json({ limit: limiteCorpoPara(req), verify: verificarTamanhoJson })", 'backend aplica limites por rota sem remover suporte a payload grande');
