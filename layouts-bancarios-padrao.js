const LAYOUTS_BANCARIOS_PADRAO = [
  ...
  { banco: '341', nomeBanco: 'Itau Unibanco', nome: 'Itau 1 - Extrato Mensal', parser: 'parsearPDF_Itau_ExtratoMensal', formato: 'PDF textual / OCR', confiabilidade: 'Alta', status: 'Ativo', ultimoTeste: 'ITAU 05 A 12.2025.pdf', observacao: 'Le lancamentos multiline, Redecard/Rede, rendimentos e usa OCR posicional quando o PDF nao possui texto extraivel.' },
  ...
  { banco: '246', nomeBanco: 'Banco ABC Brasil', nome: 'Banco ABC - Extrato Consolidado', parser: 'parsearPDF_ABC_Extrato', formato: 'PDF textual', confiabilidade: 'Alta', status: 'Ativo', ultimoTeste: 'EXTRATO ABC 2244444-2.pdf', observacao: 'Le extrato consolidado Banco ABC com Data, Quantidade, Historico, Operacao, Valor e Saldo diario; ignora saldo anterior e evita somar saldo diario colado ao valor.' },
  { banco: '246', nomeBanco: 'Banco ABC Brasil', nome: 'Banco ABC - Extrato XLSX', parser: 'parsearArquivoXLSXBancoABC', formato: 'XLSX', confiabilidade: 'Alta', status: 'Ativo', ultimoTeste: 'EXTRATO ABC -FLANACAR 042026.xlsx', observacao: 'Le planilha Banco ABC com DATA, OPERACAO, PREFIXO/TITULO, ENTRADAS, SAIDAS e SALDO ATUAL; usa entradas como credito e saidas como debito sem somar saldo.' },
  ...
  { banco: 'CLU', nomeBanco: 'CLUDE - Club de Beneficios', nome: 'CLUDE - Analise Creditos PIS COFINS', parser: 'parsearPDF_Clude_AnaliseCreditos', formato: 'PDF fiscal', confiabilidade: 'Alta', status: 'Ativo', ultimoTeste: '733  CLUDE SERV. TOMADOS ABRIL.pdf', observacao: 'Le PDF gerado pelo Consultor Fiscal com Analise de Creditos PIS/COFINS; usa Valor da Nota como base fiscal e preserva historico padrao.' },
  { banco: '1183', nomeBanco: 'DAXX MIDIA LTDA', nome: 'DAXX - Analise Creditos PIS COFINS', parser: 'parsearPDF_Fiscal_AnaliseCreditosPISCOFINS', formato: 'PDF fiscal', confiabilidade: 'Alta', status: 'Ativo', ultimoTeste: '1183 - SERVICOS TOMADOS 042026.pdf', observacao: 'Le PDF gerado pelo Consultor Fiscal para DAXX com Analise de Creditos PIS/COFINS; usa Valor da Nota como base fiscal e preserva historico padrao.' },
  { banco: '1183', nomeBanco: 'DAXX MIDIA LTDA', nome: 'DAXX - Servicos Prestados Fiscal', parser: 'parsearPDF_IOB_Sage_ServicosPrestados', formato: 'PDF fiscal IOB SAGE', confiabilidade: 'Alta', status: 'Ativo', ultimoTeste: '1183 - SERV. PRESTADOS 04.2026 FISCAL 1.pdf', observacao: 'Le relatorio fixo do Office Fiscal/IOB SAGE de NFs de Servicos Prestados, usa Valor da NF como credito e preserva tomador para parametrizacao de contas e historico.' },
