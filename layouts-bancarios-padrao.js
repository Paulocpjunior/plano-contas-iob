const LAYOUTS_BANCARIOS_PADRAO = [
  ...
  { banco: '033', nomeBanco: 'Santander', nome: 'Santander 1 - Internet Banking Empresarial', parser: 'parsearPDF_Santander_InternetBanking', formato: 'PDF textual', confiabilidade: 'Alta', status: 'Ativo', ultimoTeste: 'santander abril 26 1.pdf', observacao: 'Le extrato Santander Internet Banking Empresarial agrupado por dia, com linhas CREDITO/DEBITO R$ valor.' },
  ...
  { banco: '352', nomeBanco: 'Santander CTVM', nome: 'Santander 1 - Internet Banking Empresarial', parser: 'parsearPDF_Santander_InternetBanking', formato: 'PDF textual', confiabilidade: 'Alta', status: 'Ativo', ultimoTeste: 'santander abril 26 1.pdf', observacao: 'Atende cadastros Santander CTVM que usam o extrato Internet Banking Empresarial.' },
