const LAYOUTS_BANCARIOS_PADRAO = [
  ...
  { banco: 'CLU', nomeBanco: 'CLUDE - Club de Beneficios', nome: 'CLUDE - Itau Movimentacao Financeira', parser: 'parsearArquivoTextoCludeItauCSV', formato: 'CSV/XLSX', confiabilidade: 'Media', status: 'Ativo', ultimoTeste: 'Bco Itau - Movimentacao Financeira (1).xlsx', observacao: 'Reconhece DATA PAGTO, DESCRICAO, DESPESAS e datas abreviadas como 4-mar para arquivos financeiros do cliente.' },
