(function(root, factory) {
  ...
  const LAYOUTS_FISCAIS_PADRAO = [
    {
      id: 'generico_livro_entradas_iob_sage_csv',
      codigoEmpresa: 'GEN',
      cnpj: '',
      empresa: 'Todas as empresas - Office Fiscal / IOB SAGE',
      movimento: 'entrada',
      documento: 'LIVRO_ENTRADAS_FISCAL',
      nome: 'Modelo geral - Livro de Entradas',
      parser: 'parsearCSV_IOB_Sage_LivroEntradas',
      formato: 'CSV/TXT fiscal Office Fiscal / IOB SAGE',
      extensoes: ['csv', 'txt'],
      confiabilidade: 'Alta',
      status: 'Ativo',
      homologacao_status: 'aprovado',
      validacaoCnpj: 'cadastro_codigo_empresa_arquivo',
      exigirCodigoArquivo: true,
      exigirChaveNfeTodasNotas: true,
      ultimoTeste: '0109_RelatorioNotas_20260401_20260430.Csv',
      observacao: 'Modelo reutilizavel para qualquer empresa. Confere a direcao E, a estrutura do livro, a cobertura das chaves fiscais e o codigo NNNN_ do arquivo contra o numero da empresa no cadastro do CCI.'
    },
    {
      id: 'generico_livro_saidas_iob_sage_csv',
      codigoEmpresa: 'GEN',
      cnpj: '',
      empresa: 'Todas as empresas - Office Fiscal / IOB SAGE',
      movimento: 'saida',
      documento: 'LIVRO_SAIDAS_FISCAL',
      ...
      observacao: 'Modelo reutilizavel para qualquer empresa. Confere a direcao S, a estrutura do livro, todas as chaves NF-e e o CNPJ emitente extraido delas contra o CNPJ da empresa ativa.'
    },
    {
